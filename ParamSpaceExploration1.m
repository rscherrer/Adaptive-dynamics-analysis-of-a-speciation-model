...
svalues = Range[0.01, 2.5, 0.01];
dvalues = {0.2};
mvalues = {0.1}; (* we ran the three values separately because the output was taking up too much memory *)
...
Export["adaptive_dynamics_m_0.1.csv", data, "CSV"]; (* uncomment to save the data to file *)
